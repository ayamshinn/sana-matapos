function initAdminAppointments() {
                        ...
                        if (datePickingMode) {
                            ...
                            if (isDateInPast(selectedDate)) {
                                if (appointmentMode === 'add') {
                                    ...
                                    alert('Cannot edit appointments on past dates.');
                                    return;  // Don't open modal
                                }
                            }
                            // Proceed if not past
    ...
    function isDateInPast(date) {
        ...
        dateStart.setHours(0, 0, 0, 0);  // Start of selected date
    ...
    addBtn.addEventListener("click", () => {
        if (addBtn.classList.contains('active')) {
            ...
            // If not active, activate and set mode
    ...
    // Edit button: Toggle mode and active state
