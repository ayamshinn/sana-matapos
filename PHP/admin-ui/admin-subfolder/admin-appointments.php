        ...
        <div class="div-appointment-wrapper">
            <div class="row edit-appointment-schedule-wrapper-row row-cols-1">
                ...
                <div class="block-schedule">
                    <button type="submit" id="confirm-appointment-btn" class="confirm-appointmentbtn">Confirm</button>
                    <button id="cancel-appointment-btn" class="cancel-appointmentbtn bg-danger">Cancel</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="shared-edit-appointment-wrapper">
        ...
        <div class="button-appointment-container">
            ...
            <div class="cancel-appointment">
                <button class="cancel-appointment-btn bg-danger">Cancel</button>
            </div>
        </div>
    </div>
</section>
