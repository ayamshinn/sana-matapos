<div id="admin-patient-page-id" class="information-record-main-container">
    ...
    <div class="wrapper d-flex flex-wrap">
        ...
        <div class="add-user-btn-container ms-auto">
            <button class="add-user-btn" data-page="../../PHP/admin-ui/admin-subfolder/shared-folder-add/admin-add-new.php" data-type="patient"><i class="fa-solid fa-user-plus"> </i> Add New Patient</button>
        </div>
    </div>
